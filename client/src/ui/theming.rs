...
pub const ATTR_COLOR_FOCUSED_ELEMENT: &str = "colors.common.focused_element";
pub const ATTR_COLOR_UNFOCUSED_ELEMENT: &str = "colors.common.unfocused_element";

pub const ATTR_COLOR_WORK_ACTIVE: &str = "colors.work.active";
pub const ATTR_COLOR_WORK_PARTIALLY_ACTIVE: &str = "colors.work.partially_active";
pub const ATTR_COLOR_WORK_WAITING_TO_PROCESS: &str = "colors.work.waiting_to_process";
pub const ATTR_COLOR_WORK_PROCESSING: &str = "colors.work.processing";
pub const ATTR_COLOR_WORK_ERROR: &str = "colors.work.error";
pub const ATTR_COLOR_WORK_INACTIVE: &str = "colors.work.inactive";
pub const ATTR_COLOR_WORK_IDLE: &str = "colors.work.inactive";
